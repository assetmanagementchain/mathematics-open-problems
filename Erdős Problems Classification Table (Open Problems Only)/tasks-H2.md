第一批 H2 阶段题单（Phase 1 H2 Pool）

这不是全 426 个 H2 的完整分类，而是第一批我们要认真排队的 H2 候选池，用于 Problem #2、#3、#4… 这条线。全部都附上官网链接，方便你随时点进去看原题。

统一链接格式：
https://www.erdosproblems.com/{number}

A. Additive combinatorics / additive basis / Sidon / unit fractions（主战场）
...
Prize: no（含 AP，但不带 primes/AP 强大奖牌，先视作 H2.5）

上面这 19 个可以认为是：
“Erdős H2-AC 主战场第一批候选”。
我们的 Problem #2、#3、#4… 大概率都在这堆里选。

B. Geometry / distances / convex 类型（结构很干净的 H2）
